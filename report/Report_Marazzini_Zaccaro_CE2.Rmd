...
we were asked to explain what "to crawl" means What does it mean to
crawl? What we have done for this assignment was to scrape a web page to
collect data. Crawling, instead, means to automatically collect URL from
